...
--A_type=acoustic --input_dim_a=74 --norm_method=trn --embd_size_a=128 --embd_method_a=attention \
--V_type=visual --input_dim_v=47 --embd_size_v=128  --embd_method_v=attention \
