...
from models.networks.mamba import MambaEncoder  # 导入新的 Mamba
...
# from models.utt_AVL_model import UttAVLModel  # <--- 删掉了导致报错的废弃导入
